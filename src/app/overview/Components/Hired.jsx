      ...
      >
        <div className="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <small className="text-muted">Successfully onboarded talent</small>
          </div>
        </div>
        ...
        <span
          ...
          style={{
            backgroundColor: data.length > 0 ? "rgba(16, 185, 129, 0.15)" : "#f1f5f9",
            color: data.length > 0 ? "#047857" : "#94a3b8",
            fontSize: "12px",
          }}
        >
