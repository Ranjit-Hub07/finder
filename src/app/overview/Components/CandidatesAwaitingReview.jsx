...
const CandidatesAwaitingReview = ({ data = [] }) => {
  return (
    <div
      ...
      >
        <div className="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <small className="text-muted">Applications needing your initial review</small>
          </div>
        </div>
        ...
        <span
          ...
          style={{
            backgroundColor: data.length > 0 ? "rgba(245, 158, 11, 0.15)" : "#f1f5f9",
            color: data.length > 0 ? "#b45309" : "#94a3b8",
            fontSize: "12px",
          }}
        >
...
export default CandidatesAwaitingReview;
