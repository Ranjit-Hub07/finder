      ...
      >
        <div className="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <small className="text-muted">Formal rounds completed with technical/HR teams</small>
          </div>
        </div>
        ...
        <span
          ...
          style={{
            backgroundColor: data.length > 0 ? "rgba(139, 92, 246, 0.12)" : "#f1f5f9",
            color: data.length > 0 ? "#6d28d9" : "#94a3b8",
            fontSize: "12px",
          }}
        >
