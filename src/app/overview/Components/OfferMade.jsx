      ...
      >
        <div className="d-flex align-items-center gap-2">
          ...
          <div>
            ...
            <small className="text-muted">Formal offer letter issued to candidates</small>
          </div>
        </div>
        ...
        <span
          ...
          style={{
            backgroundColor: data.length > 0 ? "rgba(59, 130, 246, 0.12)" : "#f1f5f9",
            color: data.length > 0 ? "#1d4ed8" : "#94a3b8",
            fontSize: "12px",
          }}
        >
